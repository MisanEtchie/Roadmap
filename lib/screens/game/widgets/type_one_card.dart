...
class TypeOneCard extends StatelessWidget {
  final Story story;


  TypeOneCard({required this.story,});
            ...
            child: Row(
              ...
              children: [
                CircleAvatar(
                  ...
                  //backgroundImage: AssetImage('${character.shockedImage}'), // Combine character and story image
                ),
